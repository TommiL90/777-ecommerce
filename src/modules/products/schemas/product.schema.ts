...
export const ProductSchema = z.object({
  id: z
    .string()
    .uuid()
    .describe("Identificador único UUID del producto generado por el sistema"),
  sku: z
    ...
    .describe(
      "Código SKU único del producto para identificación e inventario. Ejemplo: SKU048546"
    ),
  name: z
  ...
  stock: z
    ...
    .describe(
      "Cantidad de unidades disponibles en inventario. Ejemplo: 10"
    ),
  brand: z
    ...
    .nullable()
    .describe(
      "Marca o fabricante del producto (opcional). Ejemplo: Royal Canin, Purina"
    ),
  categoryId: z
  ...
  createdAt: z.coerce
    .date()
    .describe("Fecha y hora de creación del registro en el sistema"),
  updatedAt: z.coerce
    .date()
    .describe("Fecha y hora de la última actualización del registro"),
});
...
export const CreateProductSchema = ProductSchema.omit({
  ...
  stock: z
    ...
    .default(0)
    .describe(
      "Cantidad inicial en inventario (opcional, por defecto 0). Ejemplo: 10"
    ),
});
